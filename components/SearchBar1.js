...
const FlatlistDemo2 = () => {
   ...
   useEffect( ()=>{ (async() =>{
      const dt = await DataStore.query(Dish,bd =>bd.canteenID('4a818cea-c096-440a-9391-d65b199e213c'));
      console.log(dt)
})}, [Dish]);
      ...
      <View style={{ flex: 1 }}>
         <View
            ...
            <View
               ...
               <Image
                  source={{uri:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7uNHb-w74fi4N4_buUH-GfJO7ThpniyDu-Q&usqp=CAU'}}
